...
sealed class ExecutionPlatform {
     ...
     */
    abstract fun printError(errorCode: Int, message: String)

    /**
     * コマンド
     */
    object Command : ExecutionPlatform() {
        override fun printError(errorCode: Int, message: String) {
    ...
    object Interact : ExecutionPlatform() {
        override fun printError(errorCode: Int, message: String) {
            println("${ShellColor.Red}ERROR[$errorCode]: $message${ShellColor.Reset}")
        }
    }
}
